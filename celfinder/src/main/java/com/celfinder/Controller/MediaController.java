...
public class MediaController {
    private final ComparadorMedia comparadorMedia = new ComparadorMedia();
    private final Celularmedia celularMedia; // Instancia para la media

    // Constructor para inicializar celularMedia con valores predefinidos
    public MediaController() {
        // Ejemplo de valores para celularMedia
        this.celularMedia = new Celularmedia(); // Cambia estos valores según necesites
    }
