...
public class CelularComparisonController {
    private final ComparadorCelular comparadorCelulares = new ComparadorCelular();
    ...
    public String registrarCelulares(@RequestParam String nombre,
        ...
        // Verificar resultados y agregar al modelo
        ...
        model.addAttribute("mensaje", "Los celulares se han registrado correctamente."); // Mensaje de confirmación
